    ...
    >
      ...
      <div class="dialog-content">
        <div class="dialog-header">
          <div class="dialog-header-title">CẬP NHẬT THÔNG TIN</div>
            ...
            <div class="m-col el-left m-flex-4">
              ...
              <div class="m-row mg-top-0 m-flex">
                <div class="m-col m-flex-1">
                  ...
                  <div class="m-control">
                    <input
                    v-model="updateEmployee.EmployeeCode"
                      id="txtEmployeeCode"
...
<script>
export default {
  props: ["ishide", "infoEmployee"],
  data() {
    return {
      updateEmployee: {
        Address: this.infoEmployee.Address,
        DateOfBirth: this.infoEmployee.DateOfBirth,
        DepartmentId: this.infoEmployee.DepartmentId,
        DepartmentName: this.infoEmployee.DepartmentName,
        EducationalBackground: this.infoEmployee.EducationalBackground,
        Email: this.infoEmployee.Email,
        EmployeeCode: this.infoEmployee.EmployeeCode,
        EmployeeId: this.infoEmployee.EmployeeId,
        FirstName: this.infoEmployee.FirstName,
        FullName: this.infoEmployee.FullName,
        Gender: this.infoEmployee.Gender,
        GenderName: this.infoEmployee.GenderName,
        IdentityDate: this.infoEmployee.IdentityDate,
        IdentityNumber: this.infoEmployee.IdentityNumber,
        IdentityPlace: this.infoEmployee.IdentityPlace,
        JoinDate: this.infoEmployee.JoinDate,
        LastName: this.infoEmployee.LastName,
        MaritalStatus: this.infoEmployee.MaritalStatus,
        PersonalTaxCode: this.infoEmployee.PersonalTaxCode,
        PhoneNumber: this.infoEmployee.PhoneNumber,
        PositionId: this.infoEmployee.PositionId,
        PositionName: this.infoEmployee.PositionName,
        QualificationId: this.infoEmployee.QualificationId,
        QualificationName: this.infoEmployee.QualificationName,
        Salary: this.infoEmployee.Salary,
        WorkStatus: this.infoEmployee.WorkStatus,
        WorkStatusName: this.infoEmployee.WorkStatusName,
      },
      dialog: false,
      display: "none",
    };
  ...
  methods: {
    btnUpdateOnClick() {
      console.log(this.updateEmployee.FullName);
      console.log(this.infoEmployee);
    },
    btnCancelOnClick() {
      this.$emit("ishideToUpdate", true);
    },
    rowOnClick(employee) {
